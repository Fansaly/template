...
import { LoadMoreState, PageQuery } from '@/components/LoadMore/types';

const keyword = ref<undefined | string>(undefined);
const typeId = ref<undefined | string>(undefined);
const tabs = ref<
  Array<{
    name: string;
    [key: string]: any;
...
>([{ name: '全部' }]);
const state: Partial<LoadMoreState> = reactive({});
const list = ref<Array<Record<string, any>>>([]);
const loadMoreRef = ref<null | InstanceType<typeof LoadMore>>(null);
...
const fetchList = async (params: PageQuery) => {
...
const handleChange = (data: LoadMoreState) => {
