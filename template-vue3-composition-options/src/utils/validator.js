...
export const validateMobile = (rule, value) => {
  let { required } = rule;
...
export const validatePhoneNo = (rule, value) => {
  return new Promise((resolve, reject) => {
...
export const validateSmsCode = (rule, value) => {
  return new Promise((resolve, reject) => {
    if (!/^[\d]{6}$/.test(value)) {
...
export const validateID = (rule, value) => {
  return new Promise((resolve, reject) => {
    if (!value) {
